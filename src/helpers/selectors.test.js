...
test.skip("getInterviewersForDay returns an array with a length matching the number of interviews for that day", () => {
  const result = getInterviewersForDay(state, "Monday");
  expect(result.length).toEqual(3);
});

test.skip("getInterviewersForDay returns an array containing the correct interview objects", () => {
